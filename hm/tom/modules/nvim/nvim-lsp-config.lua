...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<space>lref', '<cmd>lua vim.lsp.buf.references()<CR>', opts)
  ...
  buf_set_keymap('n', '<space>lql', '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>', opts)
  buf_set_keymap('n', '<space>lqf', '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>', opts)
