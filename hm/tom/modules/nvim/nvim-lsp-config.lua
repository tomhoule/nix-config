...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<space>lref',  "<cmd>lua require('telescope.builtin').lsp_references()<CR>", opts)
  buf_set_keymap('n', '<space>la', "<cmd>lua require('telescope.builtin').lsp_code_actions()<CR>", opts)
  ...
  buf_set_keymap('n', '<space>lqf', '<cmd>lua vim.diagnostic.set_loclist()<CR>', opts)
